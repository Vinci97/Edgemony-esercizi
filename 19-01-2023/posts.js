...
const img1 = document.querySelector('#imagesImg1') 
const img2 = document.querySelector('#imagesImg2')
const img3 = document.querySelector('#imagesImg3')
